...
export const initialData: SeedData = {
  ...
  products: [
    ...
    },
    {
      ...
      slug: 'men_quilted_shirt_hoddie',
      type: ProductTypes.HODDIE,
      tags: [ProductTags.HODDIES],
...

    {
      ...
      slug: 'men_raven_lightweight_zip_up_bomber_hoddie',
      type: ProductTypes.SHIRT,
      tags: [ProductTags.SHIRTS],
...

    {
      ...
      stock: 50,
      price: 45,
      sizes: [ProductSizes.XS, ProductSizes.S, ProductSizes.M, ProductSizes.L],
    ...
    },
    {
      ...
      stock: 15,
      price: 35,
      sizes: [ProductSizes.S, ProductSizes.M, ProductSizes.L, ProductSizes.XL],
    ...
    },
    {
      ...
      stock: 12,
      price: 35,
      sizes: [ProductSizes.XS, ProductSizes.S, ProductSizes.M],
    ...
    },
    {
      ...
      stock: 5,
      price: 35,
      sizes: [ProductSizes.XS, ProductSizes.S],
    ...
    },
    {
      ...
      stock: 24,
      price: 35,
      sizes: [ProductSizes.XL, ProductSizes.XXL],
    ...
    },
    {
      ...
      stock: 5,
      price: 30,
      sizes: [ProductSizes.XS, ProductSizes.S, ProductSizes.XXL],
    ...
    },
    {
      ...
      stock: 150,
      price: 30,
      sizes: [ProductSizes.M, ProductSizes.L],
    ...
    },
    {
      ...
      stock: 12,
      price: 40,
      sizes: [ProductSizes.XS, ProductSizes.XXL],
    ...
    },
    {
      ...
      type: ProductTypes.HAT,
      tags: [ProductTags.HATS],
    ...
    },
    {
      ...
      price: 225,
      sizes: [ProductSizes.XS, ProductSizes.S, ProductSizes.M],
      slug: 'women_cropped_puffer_hoddie',
      type: ProductTypes.HODDIE,
      tags: [ProductTags.HODDIES],
    ...
    },
    {
      ...
      stock: 16,
      price: 35,
      sizes: [ProductSizes.S, ProductSizes.M],
    ...
    {
      description:
        'Wear your Kids Cyberquad Bomber Jacket during your adventures on Cyberquad for Kids. The bomber hoddie' +
        ' features' +
        ' a graffiti-style illustration of our Cyberquad silhouette and wordmark. With three zippered pockets and our signature T logo and Tesla wordmark printed along the sleeves, Kids Cyberquad Bomber Jacket is perfect for wherever the trail takes you. Made from 60% cotton and 40% polyester.',
      images: ['1742702-00-A_0_2000.jpg', '1742702-00-A_1.jpg'],
      stock: 10,
      price: 65,
      sizes: [ProductSizes.XS, ProductSizes.S, ProductSizes.M],
      slug: 'kids_cyberquad_bomber_hoddie',
      type: ProductTypes.SHIRT,
      tags: [ProductTags.SHIRTS],
